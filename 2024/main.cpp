...
unique_ptr<Solution> get_solution(int day_number) {
    Solution* p = nullptr;
    switch (day_number)
    {
...
int main(int argc, const char *argv[]) {
    ...
    unique_ptr<Solution> solution = get_solution(day_number);
    if (solution) {
        cout << "day " << day_number << " part1 is: " << solution->part1(input_file) << endl;
        cout << "day " << day_number << " part2 is: " << solution->part2(input_file) << endl;
    }
